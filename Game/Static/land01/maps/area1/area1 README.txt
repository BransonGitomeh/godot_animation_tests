...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=area1&box=10.510082,42.912347,9.970403,42.517091
...
-----------
  ...
  * area1 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * area1 Height Map (SRTM3 v4.1).png
  ...
  * area1 Height Map (SRTM30 Plus).png
